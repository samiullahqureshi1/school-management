  ...
  return (
    ...
    <div className="mb-6 p-2 rounded-lg  border border-purple-500 shadow-sm">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <h6 className='text-center text-gray-950 font-bold text-2xl pb-2'>Add New Class</h6>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label htmlFor="tuitionFees" className="block text-sm font-medium text-gray-700">
          ...
          <div>
            ...
            <select
              ...
              required
             className="mt-1 block w-full border border-#a855f7 rounded-3xl p-2 focus:ring-indigo-500 focus:border-indigo-500"
             style={{ borderColor: '#a855f7' }}
            >
